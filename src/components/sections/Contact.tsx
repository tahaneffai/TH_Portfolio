          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                ...
                >
                  <label htmlFor="from_name" className="block text-sm font-medium mb-2 text-foreground">
                    Full Name
                  </label>
                  <input
                    type="text"
                ...
                <motion.div
                  ...
                  transition={{ duration: 0.2 }}
                >
                  <label htmlFor="from_email" className="block text-sm font-medium mb-2 text-foreground">
                    Email Address
                  </label>
                  <input
                    type="email"
              ...
              <motion.div
                ...
                transition={{ duration: 0.2 }}
              >
                <label htmlFor="service_selected" className="block text-sm font-medium mb-2 text-foreground">
                  Service Type
                </label>
                <select
                  id="service_selected"
